...
namespace GlowBook.Model.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Customers",
                columns: new[] { "Id", "Email", "IsDeleted", "Name", "Notes", "Phone" },
                values: new object[] { 1, "anna@example.com", false, "Anna V.", null, null });

            migrationBuilder.InsertData(
                table: "Services",
                columns: new[] { "Id", "DurationMin", "IsDeleted", "Name", "Price" },
                values: new object[,]
                {
                    { 1, 60, false, "Wimperlift", 55m },
                    { 2, 45, false, "Manicure", 40m },
                    { 3, 60, false, "Pedicure", 50m }
                });

            migrationBuilder.InsertData(
                table: "Staff",
                columns: new[] { "Id", "IsActive", "IsDeleted", "Name", "Role" },
                values: new object[] { 1, true, false, "Tamara", "Beautician" });
